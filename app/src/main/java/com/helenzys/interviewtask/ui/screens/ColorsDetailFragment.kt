 ...
 * Use the [ColorsListFragment.newInstance] factory method to
...
class ColorsListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ColorsListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ColorsListFragment().apply {
    ...
    override fun onStart() {
        ...
        viewModel.getSelectedData().observe(viewLifecycleOwner, Observer {
            mainLayout.setBackgroundColor(it.color);
        })
    }
}